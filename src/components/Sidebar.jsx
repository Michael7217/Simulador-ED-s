    ...
    return (
        <aside className={`${props.estado ? "translate-x-0" : "-translate-x-full"} fixed inset-y-0 left-0 z-50 bg-azul w-72 flex-col items-center border-2 border-amarelo rounded-xl px-8 pt-8 transition-transform duration-300`}>
            ...
            <div className="flex flex-col gap-6 mt-10 w-full">
                ...
                <div className="gap-4 text-xl cursor-pointer pb-2 border-b-2 border-b-ciano text-amarelo">
                ...
                <div className="flex items-center gap-4 text-xl cursor-pointer pb-2 border-b-2 border-b-ciano text-amarelo">
                    <Link to='/lista-encadeada' className="flex items-center gap-3">
                ...
                <div className="gap-4 text-xl cursor-pointer pb-2 border-b-2 border-b-ciano text-amarelo">
                    <Link to='/fila' className="flex items-center gap-3">
                        <img src={EstIcon} className="w-8 h-8" />
                        <h2>Fila</h2>
                    </Link>
                </div>
                ...
                <div className="gap-4 text-xl cursor-pointer pb-2 border-b-2 border-b-ciano text-amarelo">
                    <Link to='/pilha' className="flex items-center gap-3">
                        <img src={EstIcon} className="w-8 h-8" />
                        <h2>Pilha</h2>
                    </Link>
                </div>

                <div className="gap-4 text-xl cursor-pointerpb-2 border-b-2 border-b-ciano text-amarelo">
                    <Link to='/arvore-binaria' className="flex items-center gap-3">
