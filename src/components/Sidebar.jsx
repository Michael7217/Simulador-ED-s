            ...
            <aside className={`${props.estado ? "translate-x-0" : "-translate-x-full"} absolute inset-y-0 left-0 z-50 bg-azul w-72 h-screen overflow-y-auto flex flex-col items-center border-2 border-amarelo rounded-xl px-8 pt-8 transition-transform duration-300`}>
                ...
                <div className="flex flex-col w-full mt-8 mb-10">
                    ...
                    <div className="border-b-2 border-ciano py-3"> 
                        <Link to='/' className="flex items-center gap-3 text-lg text-amarelo hover:!text-branco transition-colors" onClick={() => props.funcao()}>
                    ...
                    <div className="border-b-2 border-ciano py-3">
                        <Link to='/simulacao/lista-encadeada' className="flex items-center gap-3 text-lg text-amarelo hover:!text-branco transition-colors" onClick={() => props.funcao()}>
                    ...
                    <div className="border-b-2 border-ciano py-3">
                        <Link to='/simulacao/fila' className="flex items-center gap-3 text-lg text-amarelo hover:!text-branco transition-colors" onClick={() => props.funcao()}>
                            <img src={EstIcon} className="w-7 h-7 object-contain" alt="Estrutura"/>
                            <h2>Fila</h2>
                        </Link>
                    </div>
                    ...
                    <div className="border-b-2 border-ciano py-3">
                        <Link to='/simulacao/pilha' className="flex items-center gap-3 text-lg text-amarelo hover:!text-branco transition-colors" onClick={() => props.funcao()}>
                            <img src={EstIcon} className="w-7 h-7 object-contain" alt="Estrutura"/>
                            <h2>Pilha</h2>  
                        </Link>
                    </div>
                    ...
                    <div className="border-b-2 border-ciano py-3">
                        <Link to='/simulacao/arvore-binaria' className="flex items-center gap-3 text-lg text-amarelo hover:!text-branco transition-colors" onClick={() => props.funcao()}>
                            <img src={EstIcon} className="w-7 h-7 object-contain" alt="Estrutura"/>
                    ...
                    <div className="border-b-2 border-ciano py-3">
                        <Link to='/simulacao/arvore-avl' className="flex items-center gap-3 text-lg text-amarelo hover:!text-branco transition-colors" onClick={() => props.funcao()}>
                            <img src={EstIcon} className="w-7 h-7 object-contain" alt="Estrutura"/>
                            <h2>Árvore AVL</h2> 
                        </Link>   
                    </div>
                    ...
                    <div className="border-b-2 border-ciano py-3 border-none">
                        <Link to='/sobre' className="flex items-center gap-3 text-lg text-amarelo hover:!text-branco transition-colors" onClick={() => props.funcao()}>
